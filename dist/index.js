...
function init() {
    return __awaiter(this, void 0, void 0, function* () {
        const command = new client_sqs_1.ReceiveMessageCommand({
            QueueUrl: "https://sqs.ap-south-1.amazonaws.com/691654398267/gautammanocha22112001-raw-video-queue",
                ...
                for (const message of Messages) {
                    ...
                    for (const record of event.Records) {
                        ...
                        const runTaskCommand = new client_ecs_1.RunTaskCommand({
                            taskDefinition: "arn:aws:ecs:ap-south-1:691654398267:task-definition/video-transcoder",
